...
describe Item, type: :model do
  ...
  describe 'instance methods' do
    ...
    it 'no orders' do
      ...
      order = Order.create(name: 'Meg', address: '123 Stang Ave', city: 'Hershey', state: 'PA', zip: 17_033, user_id: @user.id)
    ...
    it '#no_discounts?' do
      ...
      expect(item.no_discounts?).to eq(false)
      expect(item_2.no_discounts?).to eq(true)
    end
